...
\section{Skills}
 \resumeSubHeadingListStart
    \small{\item{
     \textbf{Languages}{: Typescript \& Javascript, Python, Java, C, C\#, Rust, Elixir, HTML/CSS, SQL} \\
     \textbf{Frameworks}{: React, Svelte, Flask, .NET Core/Framework, NextJS} \\
     \textbf{Developer Tools}{: Git, Docker, Google Cloud Platform, Kubernetes, GitHub Actions, Linux/Unix}
    }\vspace{-5pt}}
 \resumeSubHeadingListEnd
