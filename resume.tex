...
\begin{center}
    ...
    \href{https://portfolio.baetylboy.biz}{\underline{\smash{portfolio.baetylboy.biz}}} \\ \vspace{-3pt}
\end{center}
...
\section{Campus Involvement}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Built a responsive React.js \& NextJS frontend and Flask API for a portfolio dashboard leveraging yahoo finance’s web API, leading to more informed decision-making for the fund}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Developer Tools}{: Git, Docker, Google Cloud Platform, VS Code, Visual Studio, Azure, Agile Methodologies, CI/CD}
    }}
 \end{itemize}
