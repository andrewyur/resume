...
\begin{center}
    ...
    \href{https://portfolio.baetylboy.biz}{\underline{\smash{portfolio.baetylboy.biz}}} \\ \vspace{-7pt}
\end{center}
...
\section{Skills}
 \resumeSubHeadingListStart
    \small{\item{
     ...
     \textbf{Frameworks}{: React, Svelte, Flask, .NET Framework/Core, NextJS} \\
     \textbf{Developer Tools}{: Git, Docker, Google Cloud Platform, VS Code \& Visual Studio, Azure DevOps}
    }\vspace{-5pt}}
 \resumeSubHeadingListEnd
